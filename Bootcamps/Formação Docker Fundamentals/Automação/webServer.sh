...
cd /tmp/"DIO-DIGITAL-INNOVATION-ONE-main"/"Bootcamps"/"Formação Docker Fundamentals"/"Desafios de Projeto"/"1º Desafio de Projeto"
...
cd /tmp/"DIO-DIGITAL-INNOVATION-ONE-main"/"Bootcamps"/"Formação Docker Fundamentals"/"Aplicação Web"
